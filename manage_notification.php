...
?>
<title>Manage Notification : Push Notification System with PHP & MySQL</title>
...
<div class="container">		
	<h2>Manage Notification: Push Notification System with PHP & MySQL</h2>	
	...
	if (isset($_POST['submit'])) { 
		if(isset($_POST['msg']) and isset($_POST['time']) and isset($_POST['loops']) and isset($_POST['loop_every']) and isset($_POST['user'])) {
			...
			echo $isSaved == 1? '* save new notification success' : 'error save data';
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $push->listUsersId($key['username']); ?></td>
			</tr>
			<?php $a++; } ?>
		</tbody>
	</table>
